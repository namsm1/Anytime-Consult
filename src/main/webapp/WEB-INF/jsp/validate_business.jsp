...
<script type="text/javascript" src="/webjars/jquery/2.1.4/jquery.min.js"></script>
   ...
   <div class="navbar navbar-inverse navbar-fixed-top">
	...
	String sql1 = "select counter from business where timing='"+timing+"'";
	...
	if(fullname==3){
		...
		%>
		<script type="text/javascript">alert("This Slot is filled up. Kindly Choose another Slot");window.location.href="/business";</script>
		<%
